...
import {
    ...
    PaymentTable, MaintenanceTable, InsuranceTable, UsersTable // Add UsersTable import
} from "./schema";
...
async function seed() {
    ...
    await db.insert(UsersTable).values([
        ...
        { 
            email: "john.employee@carrental.com", 
        ...
        { 
            email: "mary.clerk@carrental.com", 
